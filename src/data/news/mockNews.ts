 ...
 * ещё не поднят или недоступен. Каждый пункт — пересказ своими словами реального
 * события (лето 2026), с ссылкой на официальный источник. Полный текст статей
 * не копируется — только заголовок, краткое резюме и переход по sourceUrl.
 */
export const mockNews: INewsItem[] = [
  ...
  {
    id: 'demo-2',
    slug: 'spot-cifrovoy-kontrol-rf-rk-granica',
    title: 'На казахстанско-российской границе расширяется цифровой контроль товаров (СПОТ)',
    excerpt:
      'Система прослеживаемости и оперативного контроля товаров, запущенная в июне 2026 года, охватывает всё больше пунктов пропуска и должна сократить время простоя грузов на границе.',
    imageUrl: null,
    publishedAt: '2026-07-18T09:00:00Z',
    source: 'KGD',
    sourceUrl: 'https://kgd.gov.kz/ru/newslettercategory/novosti',
  },
  {
    id: 'demo-3',
